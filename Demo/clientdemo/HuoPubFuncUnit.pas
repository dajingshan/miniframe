...
uses SysUtils, Classes, System.StrUtils, System.IOUtils,
     FMX.Dialogs, FMX.Forms, System.UITypes, FMX.DialogService
     {$IFDEF Delphi6},Variants{$EndIf}{$ifdef mswindows},Winapi.Windows, Forms{$endif};
const
...
begin
  ...
  if Pos(Delimite, Text) > 0 then
  begin
    Text := System.StrUtils.ReverseString(Text);
    Delimite := System.StrUtils.ReverseString(Delimite);
    Result :=  System.StrUtils.ReverseString(GetDeliBack(Text, Delimite));
  end;
end;
