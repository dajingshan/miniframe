...
type
  ...
  published
    ...
    property LastTimeStamp: TDateTime read FLastTimeStamp write FLastTimeStamp;
...
function TIdHTTPSession.GetValues(AName: string): string;
begin
  Result := FContent.Values[AName];
end;
...
procedure TIdHTTPSession.SetSessionName(const Value: string);
begin
  FSessionName := Value;
end;

procedure TIdHTTPSession.SetValues(AName: string; const Value: string);
begin
  FContent.Values[AName] := Value;
end;
