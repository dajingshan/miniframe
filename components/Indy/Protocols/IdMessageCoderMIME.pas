...
begin
  ...
  if LContentTransferEncoding = '' then begin
    ...
    if IsHeaderMediaType(LContentType, 'application/mac-binhex40')
      ...
      LContentTransferEncoding := 'binary'; //2019-08-25 mod LContentTransferEncoding := '7bit'; {do not localize}
    end;
  end
